(function () {
    var h = {}, mt = {}, c = {
        id: "fb9cd9dcdda23cee0c7357db9be24acb",
        dm: ["meishichina.com", "mipcache.bdstatic.com", "m-meishichina-com.mipcdn.com", "home-meishichina-com.mipcdn.com", "mip-cngold-org.mipcdn.com"],
    ...
    (function () {
        ...
        var b = mt.url, d = mt.aa, f = mt.U, g = mt.lang, n = mt.cookie, l = mt.f, p = mt.localStorage, e = mt.sessionStorage, k = h.w, w = h.H;
        a.prototype = {
            P: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), e = b.K(document.referrer) === k.ea ? 1 : 0, f = b.i(a, "jn"), g = /^heatlink$|^select$|^pageclick$/.test(f);
                ...
                var b = e.get("Hm_unsent_" + c.id) || "", d = this.a.u ? "" : "&u=" + encodeURIComponent(document.location.href), b = encodeURIComponent(a.replace(/^https?:\/\//, "") + d) + (b ? "," + b : "");
                e.set("Hm_unsent_" +
                    c.id, b)
            }, T: function (a) {
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.Da || 7 < a.Ba) && c.cvcc)) {
            var g, n, l, p, e = function (a) {
                ...
                e.v = a;
                if (d) {
                    var k = d.getAttribute("href"), m = d.getAttribute("onclick") ? "" + d.getAttribute("onclick") : t, n = d.getAttribute("id") || "";
